...
namespace System
{
    ...
    public static class Environment
    {
        ...
        public static int TickCount { [SecuritySafeCritical]
        get; }

        public static int ExitCode { [SecuritySafeCritical]
        ...
        public static bool HasShutdownStarted { [SecuritySafeCritical]
        get; }
